...
<br> TyC: los términos y condiciones del Sitio publicados en la sección "Términos y Condiciones" (https://www.capacitacionee.com/Registro/Terminos) del Sitio.
...
<h4>CLÁUSULA (2). Desarrollo del Sitio</h4>
...
<br> (b) La presente Política de Privacidad y Protección de Datos Personales es parte de los TyC y debe ser leída e interpretada en conjunto con los TyC.

<h4>CLÁUSULA (3). Recolección de Datos Personales</h4>
...
<h4>CLÁUSULA (5). Negativa del Usuario</h4>
El Usuario:
...
<h4>CLÁUSULA (6). Almacenamiento de Datos Personales</h4>
El Administrador almacenará los Datos Personales en una base de datos cuya administración será responsabilidad exclusiva del Administrador en el siguiente domicilio: Vito Donato Sabia 5136, La Matanza, Pdo. de La Matanza, Provincia de Buenos Aires.

<h4>CLÁUSULA (7). Gestión de Datos Personales</h4>
...
<h4>CLÁUSULA (8). Derechos del Usuario</h4>
...
<br> (f) La Agencia de Acceso a la Información Pública, en su carácter de Órgano de Control de la Ley 25326, tiene la atribución de atender las denuncias y reclamos que interpongan quienes resulten afectados en sus derechos por incumplimiento de las normas vigentes en materia de protección de Datos Personales.

<h4>CLÁUSULA (9). Modificaciones</h4>
(a) El Administrador:
...
<h4>CLÁUSULA (10). Sitio de Tercero</h4>
...
<h4>CLÁUSULA (11). Ley Aplicable</h4>
