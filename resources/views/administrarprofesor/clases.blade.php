        ...
        <div class="col-md-12">
          <div class="page-header clearfix">
            <h2 class="detalle"><span class="infoicono"><i class='fas fa-info-circle'></i></span>
               Clases del profesor {{$user->nombre}} {{$user->apellido}}</h2>
          </div>
            ...
            <div class="row">
              @foreach ($buys as $item)
                  <div class="info-clases-item">
                    <h1>
                      {{$item->publication->titulo}} - alumno:  
                      <span class="profesor">{{$item->user->nombre}} {{$item->user->apellido}}</span>
                        </h1>
                        <p>Precio cobrado {{$item->precio}} Euros</p>
