...
<head>
    ...
    <link href="{{ asset('css/sb-admin-2.css?v=43') }}" rel="stylesheet">
                ...
                <form name="envio" id="envio" role="form" action="{{route('user.uploadcontract')}}" method="POST">
                    ...
                    <div>
                        <div class="contratodetalle">
                            ...
                            <p>CUARTA: Luego de registrarse en CCE Ud., en su calidad de Docente determinará y publicará el costo de la clase y/o curso en la plataforma, previa autorización de CCE.  El costo de los mismos debe estar publicado en moneda EURO.</p>
